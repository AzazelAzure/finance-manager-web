...
const MESSAGES: Record<AppLocale, Record<string, string>> = {
  "en-US": {
    ...
    "roadmap.imports.title": "Native Android App",
    "roadmap.imports.body": "A fast, compiled Android companion app that works seamlessly with your local-first data.",
    "roadmap.shared.title": "Advanced Sync",
    "roadmap.shared.body": "Full multi-device synchronization engine with conflict resolution and multi-currency support.",
    "roadmap.api.title": "Shared spaces",
    "roadmap.api.body": "Household and advisor views with clear permissions and granular access control.",
  ...
  "tl-PH": {
    ...
    "roadmap.imports.title": "Native Android App",
    "roadmap.imports.body": "Mabilis at compiled na Android companion app na gumagana nang walang putol sa iyong local-first data.",
    "roadmap.shared.title": "Advanced Sync",
    "roadmap.shared.body": "Buong multi-device synchronization engine na may conflict resolution at multi-currency support.",
    "roadmap.api.title": "Shared spaces",
    "roadmap.api.body": "Household at advisor views na may malinaw na permissions at granular access control.",

...
const MESSAGES: Record<AppLocale, Record<string, string>> = {
  "en-US": {
    ...
    "support.gatedMessage": "Feature requests are currently disabled for your account.",
  ...
  "tl-PH": {
    ...
    "support.gatedMessage": "Ang mga hiling sa feature ay kasalukuyang hindi pinagana para sa iyong account.",
